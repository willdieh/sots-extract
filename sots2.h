...
struct SOTS2_Header_struct {
    unsigned int SOTS2_magic_number;    //SOTS2 magic number (unknown purpose)
    char string_len;					//Length of file type descriptor string
    std::string file_type;				//file type descriptor string 
